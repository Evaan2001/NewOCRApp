...
<p align="center">
Here's the code for a [Streamlit](https://streamlit.io/">Streamlit) web-app a highly parallelized program in CUDA (Nvidia's parallel computing platform) that was able to solve 1,750,000 sudoku boards/sec by applying constraint propagation on a GPU (Graphical Processing Unit).
</p>
